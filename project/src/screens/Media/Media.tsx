              ...
              {videos.map((video, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="[font-family:'Playfair_Display',Helvetica] font-semibold text-[#7B1E2C] text-xl tracking-[0] leading-7">
                      {video.title}
                    </h3>
                    <div className="mt-3 text-sm text-slate-500">
                      <span>Source: </span>
                      <a href={video.source} target="_blank" rel="noopener noreferrer" className="text-[#7B1E2C] underline">Mandala Theatre</a>
                    </div>
                  </div>
                </a>
              ))}
              ...
              {photos.map((photo, index) => (
                ...
                >
                  <div className="aspect-square bg-slate-200 relative overflow-hidden">
                    ...
                    />
                    <div className="absolute left-3 top-3 bg-white/80 text-xs px-2 py-1 rounded text-[#7B1E2C]">{photo.category}</div>
                  </div>
                  <div className="pt-3">
